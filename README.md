...
To get started, download the repo and run `npm start`. That'll fire it up. From there, you just need to edit the resume.json file to include whatever you want. There's no official doc on the file
format, but it's chock full of examples.

When you're happy, an `npm run build` will generate build files suitable to uploading to wherever.
